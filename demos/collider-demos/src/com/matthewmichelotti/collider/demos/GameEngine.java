...
public class GameEngine {
	...
	private static class CompInteractTester implements InteractTester {
		...
		@Override public void getInteractGroups(HitBox hitBox, IntArray buffer) {
			buffer.add(GROUP_NORMAL);
			if(((Component)hitBox.getBelongingObject()).interactsWithBullets()) {
				buffer.add(GROUP_BULLET);
			}
		}
	}
}
