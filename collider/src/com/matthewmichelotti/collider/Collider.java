...
public final class Collider {
	...
	private IntArray groupArr = new IntArray();
	...
	void altering(HitBox hitBox, boolean changeInteractivity) {
		...
		if(curHitBox != null && curHitBox != hitBox) processCurHBAndCollision();
	...
	void processCurHBAndCollision(boolean checkReiterate) {
		...
		groupArr.clear();
		if(newGroup >= 0) interactTester.getInteractGroups(curHitBox, groupArr);
